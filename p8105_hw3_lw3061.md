...
Most participants had activity levels between 0-2000 when looking at
their activity data by hour.

As expected, the most activity occurred during the daywith a dip in the
early hours of the day. The peaks of all 3 panels was around midday
...
activity24 |>
  ...
  facet_wrap(.~education) +
  labs(
    x = "Hour of day", y="Activity", title ="Activity over 24 hours, with values <2000 excluded"
  )
```
